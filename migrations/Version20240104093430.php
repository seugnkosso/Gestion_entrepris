 ...
 */
final class Version20240104093430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE agent (id INT AUTO_INCREMENT NOT NULL, secteur_id INT DEFAULT NULL, nom_complet VARCHAR(50) NOT NULL, INDEX IDX_268B9C9D9F7E4405 (secteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE detail_vc (id INT AUTO_INCREMENT NOT NULL, v_c_id INT NOT NULL, produit_id INT NOT NULL, dette_par_vente_id INT DEFAULT NULL, prix_vente DOUBLE PRECISION NOT NULL, qte_vente INT NOT NULL, INDEX IDX_8BEE9886666953AA (v_c_id), INDEX IDX_8BEE9886F347EFB (produit_id), INDEX IDX_8BEE98865F62F3A5 (dette_par_vente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE secteur (id INT AUTO_INCREMENT NOT NULL, direction_id INT DEFAULT NULL, chef_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, code_uo VARCHAR(50) NOT NULL, INDEX IDX_8045251FAF73D997 (direction_id), UNIQUE INDEX UNIQ_8045251F150A48F1 (chef_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
